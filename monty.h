...
/* functions in error_f.c */
void file_err(char *);
void malloc_fail(void);

/* functions in extra_func.c */
int isnum(char *);

/* functions in opcode_f.c */
